 ...
 */
@Entity
@Table(name = "AD_USER", schema = "dbo", catalog = "ADUsers")
public class ADUserEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (extensionAttribute4 != null ? !extensionAttribute4.equals(that.extensionAttribute4) : that.extensionAttribute4 != null)
            return false;
        if (extensionAttribute7 != null ? !extensionAttribute7.equals(that.extensionAttribute7) : that.extensionAttribute7 != null)
            return false;
        if (extensionAttribute10 != null ? !extensionAttribute10.equals(that.extensionAttribute10) : that.extensionAttribute10 != null)
            return false;
    ...
    @Override
    public int hashCode() {
        int result = objectGUID != null ? objectGUID.hashCode() : 0;
        ...
        result = 31 * result + (extensionAttribute7 != null ? extensionAttribute7.hashCode() : 0);
        result = 31 * result + (extensionAttribute10 != null ? extensionAttribute10.hashCode() : 0);
